---
name: devops-expert
description: Senior DevOps and Cloud Infrastructure expert specializing in Microsoft Azure, Terraform, and Terragrunt. Use this skill when working on infrastructure as code, CI/CD pipelines, cloud architecture design, automation scripts, or any Azure-related infrastructure tasks. Applies best practices from official documentation.
---
